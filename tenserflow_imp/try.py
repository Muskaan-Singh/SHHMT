...
# arr = pd.read_table(path,sep=',',error_bad_lines=False)
# X = np.array(arr.get('b'))
# Y =np.array(arr.get('c'))
# print X.size
# print Y.size
...
IRIS_TRAINING = "/home/mandeep/PycharmProjects/samsadhni/data.csv"
IRIS_TEST = "/home/mandeep/PycharmProjects/samsadhni/data.csv"
